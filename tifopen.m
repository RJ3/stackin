...
% 2019-06-14 - PCO uses BigTIFF format with the extension ".pcoraw"
...
switch nargin
    case 0 % source was unspecified
        [fname,pname]=uigetfile({'*.tif;*.tiff;*.pcoraw',...
        'TIFF stack (*.tif, *.tiff, *.pcoraw)'},'Select a BigTIFF Stack',seed);
        source=[pname,fname];    
